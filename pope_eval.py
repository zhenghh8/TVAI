...
if __name__ == '__main__': 
    ...
    #         visualize(attn_img, 'no_hall_img', cmap='viridis', save_dir=save_dir)
    #         save_dir = os.path.join(attn_save_dir, 'no_hall', 'text_{}_'.format(i) + image_id + '.png')
    #         visualize(attn_text, 'no_hall_text', cmap='viridis', save_dir=save_dir)
    #         i += 1
    #     else:
    #         save_dir = os.path.join(attn_save_dir, 'hall', 'img_{}_'.format(i) + image_id + '.png')
    #         visualize(attn_img, 'hall_img', cmap='viridis', save_dir=save_dir)
    #         save_dir = os.path.join(attn_save_dir, 'hall', 'text_{}_'.format(i) + image_id + '.png')
    #         visualize(attn_text, 'hall_text', cmap='viridis', save_dir=save_dir)
    #         i += 1
    #     if i % 6 == 0:
    #         i = 0
    #### for attention statistics
    ...
    # visualize(mean_hall_img_attn, 'hall_img', save_dir=os.path.join('results_analysis', dir_name, base_name + '_hall_img.png'))
    # visualize(mean_hall_text_attn, 'hall_text', save_dir=os.path.join('results_analysis', dir_name, base_name + '_hall_txt.png'))
    # visualize(mean_nonhall_img_attn, 'nonhall_img')
    # visualize(mean_nonhall_text_attn, 'nonhall_text')
