...
class Config:
    def __init__(self, args):
        ...
        user_config = self._build_opt_list(self.args.options)  # self.args.options = None

        config = OmegaConf.load(self.args.cfg_path)  # self.args.cfg_path = eval_config/minigpt4_eval.yaml
